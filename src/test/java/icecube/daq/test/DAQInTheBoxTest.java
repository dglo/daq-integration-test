    ...
    extends DAQTestCase
{
    ...
    private List<ISourceID> idList;
    private WritableByteChannel amTail;
    private int numAmandaInputs;

    public DAQInTheBoxTest(String name)
    {
        super(name);
    }
    ...
    private ArrayList<ByteBuffer> getAmandaTriggers()
        throws DataFormatException, IOException
    {
        ...
        throws DataFormatException, IOException
    {
        ...
        // send stop message to amanda trigger
        DAQTestUtil.sendStopMsg(amTail);

        // send stop messages to stringHubs
        ByteBuffer stopBuf = ByteBuffer.allocate(32);
        stopBuf.putInt(0, 32);
    ...
    {
        return new TestSuite(DAQInTheBoxTest.class);
    }
